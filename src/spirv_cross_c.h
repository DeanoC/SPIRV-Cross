...
{
	/* This backend can only perform reflection, no compiler options are supported. Maps to gfx_spirvcross::Compiler. */
	SPVC_BACKEND_NONE = 0,
	SPVC_BACKEND_GLSL = 1, /* gfx_spirvcross::CompilerGLSL */
...
/* Maps to gfx_spirvcross::SPIRType::BaseType. */
...
/* Maps to the various gfx_spirvcross::Compiler*::Option structures. See C++ API for defaults and details. */
